...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
  \textbf{\Large Scott Koppula}  & \href{mailto:skoppula@mit.edu}{\nolinkurl{skoppula@mit.edu}}\\
...
\large \textbf{Work Experience\vspace{1mm}} \normalsize
	...
	\begin{itemize}
            \resitem{Productionized model to classify account registration and login events on Yahoo services as spam. Demonstrated a 6\% improvement in classifier's equal error rate from prior system. Deployed a multi-threaded data feed service to pull data from Facebook ThreatExchange to update classifier.}
	\end{itemize}
