...
\large \textbf{Work Experience\vspace{1mm}} \normalsize
	...
	\begin{itemize}
            \resitem{Prototyped neural network to classify account registration and login events on Yahoo services as spam. Demonstrated a 6\% improvement in classifier's equal error rate from prior system. Deployed a multi-threaded data feed service to pull data from Facebook ThreatExchange to update classifier. Awarded outstanding intern project bonus.}
	\end{itemize}
...
\large \textbf{Skills\vspace{1mm}} \normalsize
	 \begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
         \hspace{2mm} Embedded Systems/Electronics: \textbf{Altium}, \textbf{C}, \textbf{x86 Assembly}, \textbf{Vivado HLS}, and \textbf{Bluespec Verilog}. \\
